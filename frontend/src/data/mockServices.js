export const mockServices = [
  ...
  },
  {
    ...
    provider: {
      ...
      about:
        "As a certified landscape designer with a degree in Horticulture, I bring creativity and expertise to every garden project. My services include garden maintenance, landscape design, plant selection, and seasonal care.\n\nI believe in creating sustainable, beautiful outdoor spaces that enhance both the aesthetic and value of your property. Each project is tailored to the specific needs of the client and the local climate.",
      reviews: [],
    },
    rating: 4.7,
    reviews: [],
